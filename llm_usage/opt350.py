...
# CONFIGURAZIONE
model_dir = "/mnt/storage/optsmall/facebook_opt-350m"  # Cartella del modello salvato
output_file = "/home/ubuntu/projects/LLMRSResearch/llm_usage/llm_responses/opt350_eval.json"  # File di output
