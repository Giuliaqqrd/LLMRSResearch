...
# CONFIGURAZIONE
model_dir = "/mnt/storage/optsmall/facebook_opt-125m"  # Cartella del modello salvato
output_file = "/home/ubuntu/projects/LLMRSResearch/llm_usage/llm_responses/opt125_eval.json"  # File di output
